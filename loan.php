      ...
      <form action="scripts.php" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="decimal" name="loan_amount" class="form-control" placeholder="Enter amount Loaned" required>
          </div>
          <div class="form-group">
            <label>Loan Date</label>
            <input type="date" name="loan_date" class="form-control" placeholder="Enter Today's Date" required>
          </div>
          <div class="form-group">
            <label>Return Amount</label>
            <input type="Decimal" name="return_amount" class="form-control" placeholder="Enter amount to be returned" required>
          </div>
          <div class="form-group">
...
<div class="container-fluid mt-5">
  <div class="card shadow mb-4 mr-5">
    ...
    <div class="card-body">
      <table id="staffTable" class="table table-bordered text-center" width="100%" cellspacing="0">
        <thead>
        ...
        <tbody>
          <?php while($row = mysqli_fetch_assoc($output)): ?>
            <tr>
              ...
              <td><a href="LoanUpdate.php?id=<?php echo $row['loan_id'];?>" class="btn btn-success">update</td>
            </tr>
          <?php endwhile; ?>
        </tbody>
      </table>
