...
<form method="POST" action="scripts.php" enctype="multipart/form-data">
                                  ...
                                  <div class="">
                                    ...
                                    <input type="text" class="form-control" id="recipient-name" name="Name" value="<?php echo $table['Employee_Name']?>">
                                  </div>
                                  <div class="">
                                  ...
                                  <div class="">
                                    ...
                                    <input type="text" class="form-control" id="recipient-name" name="Phone" value="<?php echo $table['Password']?>">
                                  </div>
                                  <div class="">
                                    <label for="recipient-name" class="col-form-label">Enroll Number:</label>
                                    <input type="text" class="form-control" id="recipient-name" name="EnrollNumber" value="<?php echo $table['Outlet_Name']?>">
                                  </div>
                                  <div class="">
                                    <label for="recipient-name" class="col-form-label">Date of admission:</label>
                                    <input type="text" class="form-control" id="recipient-name" name="DateOfAdmission" value="<?php echo $table['Position']?>">
                                  </div>
