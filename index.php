...
<div class="container-fluid">
  ...
  <div class="row mr-5 mt-5">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-success shadow py-4">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
              ...
              <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                <span>REPORTS</span>
                  ...
                  <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="national_sales.php">Local sales</a><br>
                    <a class="collapse-item" href="national_stock.php">National Stock</a><br>
                    <a class="collapse-item" href="local_stock.php">Local Stock</a><br>
                  </div>
                  </div>
                </div>
              </div>
