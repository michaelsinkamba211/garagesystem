...
<div class="container w-50">
  <form method="POST" action="update.php" enctype="multipart/form-data">
    <div class="mb-3">
            ...
            <input type="text" name="loan_amount" value="<?php echo $row['loan_amount'];?>" class="form-control" required >
            </div>
            <div>
            <label for="phone" class="form-label">Loan Date</label>
            <input type="date" name="loan_date" value="<?php echo $row['loan_date'];?>" class="form-control" required >
            </div>
            <div>
            <label for="position" class="form-label">Paid</label>
            <input type="text" name="paid" value="<?php echo $row['Paid'];?>" class="form-control" required >
            </div>
            <div class="mb-3">
            <label for="garage-number" class="form-label">Return Amount</label>
            <input type="text" name="return_amount" value="<?php echo $row['return_amount'];?>" class="form-control" required >
            </div>
            <div class="mb-3">
            <label for="garage-number" class="form-label">Due Date</label>
            <input type="date" name="return_date" value="<?php echo $row['due_date'];?>" class="form-control" required >
            </div>
