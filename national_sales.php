...
<div class="card shadow mb-4 mr-5">
  <div class="card-header py-4"> 
    ...
    <ul class="mr-3">
    <a ><button  type="text" class="btn btn-primary mt-2 "onclick="print()">Print</button></a>
</ul>
...
$result = mysqli_query($db, $query);
    ?>
      ...
      <table class="mb-3 table-bordere text-center float-right" id="dataTable" width="30%" cellspacing="0">
        ...
        <tr>
            ...
            ?>
                ...
                <td class="text-weight-bold">K <?Php echo $row['total_sales'];?></td>
                </tr>
            <?php    
            }
            ?>
