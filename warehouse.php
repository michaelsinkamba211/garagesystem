...
<div class="card shadow mb-4 mr-5">
  ...
  <div class="card-body">
      ...
      <table id="warehouseAddTable" class="table table-bordered text-center text-dark" id="dataTable" width="100%" cellspacing="0">
        <thead>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <form action="scripts.php" method="POST">
                <input type="hidden" name="warehouse_delete_id" value="<?php echo $row['WarehouseID'] ?>">
