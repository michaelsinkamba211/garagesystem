...
<div class="card shadow mb-4 mr-5">
  <div class="card-header py-4"> 
    ...
    <a class="link" href="index.php">
            <button type="button" class="btn btn-danger mt-2 ml-3">BACK</button></a>  
    </h6>
    </div>
  <div class="card-body">
  <?php 
...
?>
      ...
      <table class="mb-3 table-border text-center float-right" id="dataTable" width="30%" cellspacing="0">
        ...
        <tr>
            <td class="text-dark text-weight-bold">K <?Php echo $row['total_discounts'];?></td>
            <td class="text-weight-bold"><?Php echo $row['total_products'];?></td>
            <td class="text-dark text-weight-bold">K <?Php echo $row['total_sales'];?></td>
        </tr>
      </table>
